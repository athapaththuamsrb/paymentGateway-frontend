...
export class AppComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const hashSquance1 = `${timeStamp}.${merchantId}.${this.sandboxForm.get("ORDER_ID")}.${this.sandboxForm.get("AMOUNT")}.${this.sandboxForm.get("CURRENCY")}`;
    var hash1 = sha1(hashSquance1);
    const hashSquance2 = `${hash1}.${sharedSecret}`;
    var hash2 = sha1(hashSquance2);
