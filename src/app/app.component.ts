...
export class AppComponent {
  ...
  sandboxForm = new FormGroup({
    ...
    ORDER_ID: new FormControl("E99ITTkYRZihMPqTXWYz5l"),//have to change every transaction
    ...
    MERCHANT_RESPONSE_URL: new FormControl(" https://1e26-2402-4000-10c4-71ed-e4ce-4171-d53c-339b.ap.ngrok.io/api/v1/paymentGateway/response"),
